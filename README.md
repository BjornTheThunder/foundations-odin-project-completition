...
This repo shows my completition of the **Foundations Path** of Odin Project trough the display of the various project did during my learning process.

<p align="center">
  <img src="foundation.svg" alt="The Odin Project Badge">
</p>

---

## Description
The Foundations course covered the basics for the start of any web developer journey: covering the basics of HTML, CSS and JavaScript.

**Key concepts learned:**
* Semantic HTML5 & CSS Layouts (Flexbox/Grid)
